...
const BarChart = ({ guide = 0, revenue = 0, subscription = 0 }) => {
  ...
  const chartOptions = {
    ...
    xaxis: {
      categories: ["Guide Revenue", "Donation Revenue", "Subscription Revenue"],
    },
    colors: ["#008FFB", "#00E396", "#FEB019"], // Colors for the bars
  };

  const chartSeries = [
    {
      name: "Revenue",
      data: [guide, revenue, subscription], // Values for each bar
    },
  ];
