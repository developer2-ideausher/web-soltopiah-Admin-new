      ...
      {showLogin && (
        <div className="w-1/2 flex items-center justify-center bg-white">
          <div className="flex flex-col gap-6 w-full lg:p-20 xl:p-32 2xl:40">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-row items-center  gap-4 xl:w-full 2xl:w-[600px]">
                <input
                  type="number"
                  placeholder="_"
                  className="bg-[#EEEEF6] p-5 lg:w-[52.67px]  xl:w-[52.67px]  2xl:w-[82.67px] rounded-lg xl:text-lg 2xl:text-2xl font-sans font-medium text-[#82829B]"
                />
                <input
                  type="number"
                  placeholder="_"
            ...
            <Link href="/dashboard">
              <button className="bg-primary py-4 px-4 rounded-lg text-base font-sans font-semibold text-white lg:w-full xl:w-full 2xl:w-[600px]  ">
                Verify
              </button>
            </Link>
          </div>
