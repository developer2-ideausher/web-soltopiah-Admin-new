      ...
      <div className="flex flex-col">
        ...
        <div className="w-full overflow-x-scroll booking-table-wrapper">
          ...
          <div className="flex flex-col bg-white min-w-fit w-full">
            <div className=" grid grid-cols-userCommunityParticipatedTable justify-between border-b border-[#E9E9EC] items-center p-4">
              ...
              <div className="font-sans font-normal text-base">1500</div>
