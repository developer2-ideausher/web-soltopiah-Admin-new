"use client"
import { addChapterInCourse, deleteMediaFromCourse, getAllCategories, getSingleCourse, updateChapterAccessibility, updateChapterInCourse, updateCourse } from '@/Utilities/Course'
...
export default function Add() {
  ...
  return (
    <div className='w-full'>
        ...
        {data && <div className='w-1/2 success pb-8'>
            ...
            {contentTab == 'single' && <AudioVideoUploader callback={audioHandler} />}
            ...
            {showContent && <div className='w-full'>
                ...
                {edited && <AudioVideoUploader type={type} uploaded={true} fileAdded={contentFile} callback={conteFileHandler} />}
