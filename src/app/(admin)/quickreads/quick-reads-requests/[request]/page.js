...
function Page({ params }) {
  ...
  const getAllReqDataApi = () => {
    ...
    fetch(
      process.env.NEXT_PUBLIC_URL + "/quick-reads/" + request,
      requestOptions
    )
  ...
  const handleDecline = (rejectionReason) => {
    ...
    fetch(
      process.env.NEXT_PUBLIC_URL + `/quick-reads/${request}/status`,
      requestOptions
    )
      .then((response) => response.json())
      .then((result) => {
          ...
          requestData && (
            <div className="flex justify-between w-full  ">
              <form
                ...
                className="flex flex-col w-3/5 gap-5 lg:w-4/5 xl:w-3/5 2xl:w-2/5"
              >
              ...
              <div className="bg-[#F4F5FB] flex  flex-col justify-center mt-20 w-2/5 mr-20 rounded-[32px] relative">
                <div className="flex flex-row justify-between items-center w-full p-8">
                  ...
                  <img
                    ...
                    src={
                      requestData.pictures[currentImageIndex]?.url ||
                      image01.src
                    }
                    alt=""
                  />{" "}
